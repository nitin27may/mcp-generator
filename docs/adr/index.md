...
[TIP §66](https://github.com/nitin27may/mcp-generator/blob/main/docs/TECHNICAL-PLAN.md#66-critical-design-decisions), so they can be cited in a code review
...
[`research/sdk-v2-api-notes.md`](https://github.com/nitin27may/mcp-generator/blob/main/docs/research/sdk-v2-api-notes.md).
